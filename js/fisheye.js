...
var deptScale = d3.fisheye.ordinal().distortion(1.9)
    ...
    newCaseG.each(function(d) {
        ...
        caseG.append('rect')
            ...
            .on('mouseover', function(d) {
                ...
                d3.select('#date').text(d.startDateStr + ' â€“ ' + ((d.endDateStr) ? d.endDateStr : 'now'))
    ...
    for (var i = 0; i < categories.length; i += 2) {
        var bar = g.append('rect')
            ...
            .on('mouseover', function(d) {
                ...
                d3.select('#date').text(d[0].dateStr + ' â€“ ' + ((d[1]) ? d[1].dateStr : 'now'));
